...
import edu.illinois.jacontebe.tools.InsideCaller;

/**
 * Bug URL:https://issues.apache.org/jira/browse/POOL-120
 * This is a race.
 * Reproduce environment: commons-pool-1.4, JDK 1.6.0_33
 * 
 * @collector Ziyi Lin
 */
public class Test120 {
    ...
    public static void main(String[] args) throws Exception {
        Reporter.reportStart("pool120", 0, "race");
    ...
    public void testEvictAddObjectsImproved() throws Exception {
        ...
        borrowerThread.setName("BorrowThread");
        ...
        Thread minIdleThread = new Thread(new Runnable() {
            public void run() {
                ...
                try {
                    InsideCaller icaller = new InsideCaller(pool);
                    icaller.callPrivateMethod("ensureMinIdle", null);
                    // pool.ensureMinIdle();
                } catch (Exception e) {
                    // Ignore
                }
        ...
        minIdleThread.setName("MinIdleThread");
        // Off to the races
        minIdleThread.start();
