...
/**
 * Bug URL:https://bugs.openjdk.java.net/browse/JDK-6492872
 * This is a deadlock. 
 * Reproduce environment: JDK 1.6.0, fixed in JDK 1.6.0_02
 * 
 * Options: 
...
public class Test6492872 {
     ...
     */
    private static String pathToStores = "./src/examples/jdk6";
    private static String keyStoreFile = "keystore";
    private static String trustStoreFile = "truststore";

    private static String keyFilename = pathToStores + "/" + keyStoreFile;
    private static String trustFilename = pathToStores + "/" + trustStoreFile;
    ...
    public static void main(String args[]) throws Exception {
        ...
        Test6492872 test = new Test6492872();
        test.runTest();
    }
     ...
     */
    public Test6492872() throws Exception {
    ...
    /*
     * Create a thread which simply spins on tasks. This will hopefully trigger
     * a deadlock between the wrap/unwrap and the tasks. On our slow, single-CPU
     * build machine (sol8), it was very repeatable.
     */
    private void doTask() {
        Runnable task;
        while (!testDone) {
     ...
     * SSLEngines we'll use for this test.
     */
