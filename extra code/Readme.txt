...
Jdk62:We manually create the target file to be tested in advance
Log4j:We reduced the number of threads that were staggered in the original test file and the number of loops of program execution.